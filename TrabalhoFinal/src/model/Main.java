...
public class Main {
    ...
    private static void inserirProduto(Scanner scanner, ProdutoDAO dao) throws IOException {
        ...
        System.out.print("Categoria (HARDWARE, PERIFERICOS, ACESSORIOS, OUTROS): ");
    ...
    private static void registrarSaida(Scanner scanner, MovimentacaoDAO mDao, ProdutoDAO pDao) throws IOException {
        ...
        double valor = Double.parseDouble(scanner.nextLine());
        System.out.print("Tipo (VENDA_CLIENTE, USO_INTERNO, DEVOLUCAO_FORNECEDOR, OUTRAS_SAIDAS): ");
        TipoSaida tipo = TipoSaida.valueOf(scanner.nextLine().toUpperCase());
