...
class SaidaTest {
    ...
    void toCSV() {
        ...
        String retorno = String.format("0;0;150.75;%s;10;VENDA_CLIENTE", data.toString());
    ...
    @Test
    void fromCSV() {
        String data = String.format("0;0;150.75;%s;10;VENDA_CLIENTE", LocalDate.now().toString());
        Saida saida1 = Saida.fromCSV(data);

        assertEquals(data, saida1.toCSV());
    }
