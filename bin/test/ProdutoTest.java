...
class ProdutoTest {
    ...
    void testToCSV() {
        ...
        String retorno = String.format("0;Pc Gamer Pichau;%s;0;10.5;HARDWARE", data.toString());
    ...
    @Test
    void testFromCSV() {
        String data = String.format("0;Pc Gamer Pichau;%s;0;10.5;HARDWARE", LocalDate.now().toString());
